...
#----------------------------------------------------------------------------------------------------------
# parametersFile="/home/sysgen/Documents/LWB/TCL/MutComp/GUI/Parameters/parameters.txt"
parametersFile="/home/sysgen/Documents/LWB/TCL/MutComp/GUI/Parameters/parameters.txt"
...
do
	...
	if [ "$parameter" == "MutCompInputFolder" ]; then
		inputFolder=$value
		pathToPdbs=$inputFolder/"pdb"/
		pathToPqrs=$inputFolder/"pqr/"
	fi
...
apbsParametersReference="$PathToMutComp/APBS/apbsReference.in"

echo "Using the following apbsReference: $apbsParametersReference"


pathToMovieCreator="$PathToMutComp/MovieCreator/"

echo "Using the following path to Movie Creator: $pathToMovieCreator"


pathToImageCreator="$PathToMutComp/ImageCreator/"
echo "Using the following path to Image Creator: $pathToImageCreator"
...
if [ "$doImageCreator" == "true" ]; then
	$pathToImageCreator./imageCreator.sh $OutputFolder $columns $FontSize
else
